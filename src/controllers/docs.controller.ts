...
const documentation: ModuleDoc[] = [
  ...
  {
    name: 'Shopping',
    description: 'Shopping lists, personal item catalog, and list–item relations',
    endpoints: [
      {
        method: 'POST',
      ...
      },
      {
        method: 'GET',
        path: '/api/shopping/lists',
        description: 'List shopping lists for the user',
        auth: true,
      ...
      },
      {
        ...
        description: 'Get shopping list with listItems (catalog + line price/qty)',
        auth: true,
        params: { listId: 'uuid' },
        response: {
          shoppingList: {
            ...
            listItems: [
              {
                ...
                price: 2.5,
                quantity: 2,
                item: { id: 'uuid', name: 'Milk', price: 2.99 },
              },
            ],
          },
        },
      ...
      },
      {
        method: 'DELETE',
        path: '/api/shopping/lists/:listId',
        description: 'Delete list (removes relations; catalog items remain)',
        auth: true,
        params: { listId: 'uuid' },
        response: { message: 'Shopping list deleted successfully' },
      },
      {
        method: 'POST',
        path: '/api/shopping/items',
        description: 'Create catalog item (optional base price)',
        auth: true,
        body: { name: 'string (required)', price: 'number (optional)' },
        response: { item: { id: 'uuid', name: 'Milk', price: 2.99 } },
      },
      {
        method: 'GET',
        path: '/api/shopping/items',
      ...
      {
        method: 'GET',
        path: '/api/shopping/items/:itemId',
      ...
      },
      {
        method: 'PATCH',
        path: '/api/shopping/items/:itemId',
        description: 'Update catalog item (name and/or price; price may be null)',
        auth: true,
        params: { itemId: 'uuid' },
        body: { name: 'optional', price: 'number | null (optional)' },
        response: { item: {} },
      },
      {
        method: 'DELETE',
        path: '/api/shopping/items/:itemId',
        description: 'Delete catalog item (removes from lists via FK)',
        auth: true,
        params: { itemId: 'uuid' },
      ...
      },
      {
        ...
        description: 'Add existing catalog item to list (line price optional; qty default 1)',
        auth: true,
        params: { listId: 'uuid' },
        body: {
      ...
      },
      {
        method: 'GET',
        path: '/api/shopping/lists/:listId/items',
        description: 'List items on a shopping list',
        auth: true,
        params: { listId: 'uuid' },
        response: { listItems: [] },
      },
      {
        method: 'PATCH',
        path: '/api/shopping/lists/:listId/items/:listItemId',
        description: 'Update line price and/or quantity',
        auth: true,
        params: { listId: 'uuid', listItemId: 'uuid' },
        body: { price: 'number | null (optional)', quantity: 'number (optional)' },
        response: { listItem: {} },
      },
      {
        method: 'DELETE',
        path: '/api/shopping/lists/:listId/items/:listItemId',
        description: 'Remove catalog item from list',
        auth: true,
        params: { listId: 'uuid', listItemId: 'uuid' },
        response: { message: 'Item removed from shopping list' },
      },
    ],
  },
  {
